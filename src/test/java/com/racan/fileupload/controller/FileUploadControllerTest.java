...
public class FileUploadControllerTest {
    ...
    public void testUploading() {
        ...
        files[0] = new File(userDir + "/upload-directory/file1.txt");
        files[1] = new File(userDir + "/upload-directory/file2.txt");
    ...
    public void testUploadingPost() throws IOException {
        ...
        String userDir = System.getProperty("user.dir");
        File expectedFile1 = new File(userDir + "/upload-directory/file1.txt");
        File expectedFile2 = new File(userDir + "/upload-directory/file2.txt");
